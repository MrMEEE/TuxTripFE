...
<style scoped>
/* Specific styling for the login background image, if you want to replicate SB Admin 2's login page */
.bg-login-image {
...
/* Override default SB Admin 2 margin on body, App.vue now manages global layout */
body {
    margin: 0;
    padding: 0;
}
